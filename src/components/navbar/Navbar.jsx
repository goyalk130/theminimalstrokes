...
const Navbar = () => {
  ...
  return (
    ...
    <div className={`${tooglenav ? "left-0" : "-left-full"} sm:hidden z-40 w-full h-full absolute top-0 left-0`} onClick={()=>{
      settooglenav(!tooglenav);
        console.log(tooglenav)
    }}></div>
    <div className={` ${tooglenav ? "left-0" : "-left-full"} sm:hidden z-50 ease-in-out duration-200 fixed h-full   top-0 w-1/3 bg-amber-700 text-white bg-opacity-90 flex flex-col justify-between items-center list-none p-0 m-0`}>
