...
const Sell = () => {
  return (
    <div id='shop' className="bg-[url('https://res.cloudinary.com/dk0qsqbcy/image/upload/v1687809702/DreamShaper_v6_An_image_illustration_of_majestic_dark_greenish_0_uxnbxj.jpg')] bg-cover  w-full p-10 md:p-20 lg:p-30 xl:p-40">
